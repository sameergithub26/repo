...
# Step 1: Find ALL UNIQUE audio files across all codecs
print("\n📊 Scanning all codec CSVs...")
all_files = set()
codec_to_label = {}  # Track which codec each file belongs to
...
# Step 2: Extract ONLY unique files
...
# Extract spoof (keep organized by codec)
